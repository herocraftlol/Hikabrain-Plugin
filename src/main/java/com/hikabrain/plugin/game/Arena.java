...
public class Arena {
    ...
    /**
     * Nombre minimum de joueurs pour CETTE arène avant de pouvoir lancer le compte à
     * rebours du lobby. -1 signifie "non défini" : on retombe alors sur le min-players
