...
public class ArenaManager {
    ...
    /**
     * Trouve l'arène (s'il y en a une) à laquelle le joueur donné est actuellement lié,
     * que ce soit en tant que joueur (lobby/partie) ou en tant que spectateur.
     */
    public GameManager findAnyArenaOf(org.bukkit.entity.Player player) {
        GameManager gm = findArenaOf(player);
        if (gm != null) {
            return gm;
        }
        return findSpectatorArenaOf(player);
    }
