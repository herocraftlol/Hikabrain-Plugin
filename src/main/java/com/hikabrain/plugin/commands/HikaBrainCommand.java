 ...
 *   /hb setminplayers <nom> <nombre>          - définit le min de joueurs avant le lancement du countdown (0 = global)
...
public class HikaBrainCommand implements CommandExecutor, TabCompleter {
    ...
    /**
     * Définit le nombre minimum de joueurs requis pour une arène spécifique avant que le
     * compte à rebours du lobby ne puisse se lancer. Un nombre <= 0 réinitialise la valeur
     * spécifique (l'arène retombera alors sur le min-players global).
     */
    ...
    private void printArenaInfo(CommandSender sender, GameManager gm) {
        ...
        MessageUtil.send(sender, "&7Joueurs minimum pour lancer le countdown : &f" + gm.getMinPlayers()
    ...
    private void sendHelp(CommandSender sender) {
        ...
        if (sender.hasPermission("hikabrain.admin")) {
            ...
            MessageUtil.send(sender, "&c/hb setminplayers <nom> <nombre> &7- Définir le nombre min de joueurs avant le countdown (0 = global)");
